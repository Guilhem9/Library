...
class Member extends HolderEntity {
    ...
    public void borrowDocument(String documentID, Library library) {
        ...
        if (library.getMembersRegistered().containsKey(memberID)) {
            ...
            if (document != null) {
                ...
                // If the document is not available in the library, print an error message
                System.out.println("This " + document.getType() + " is not in " + library.getName());
            }
        } else {
            // If member is not registered in the library, print an error message
            System.out.println("You are not a member of this Library" + library.getName() + ", please reach a Librarian to register.");
        }
    }

    // Method to return a document
    public void returnDocument(String documentID,Library library) {
        ...
        if (library.getMembersRegistered().containsKey(memberID)) {
            ...
            if (this.getDocumentsHeld().containsKey(documentID) && library.getDocumentPossessedList().containsKey(documentID)) {
                ...
                System.out.println("This document is not currently in the possession of " + toString() + "or doesn't belong to " + library.getName());
            }
        } else {
            System.out.println("Error in the log in of member " + toString() + ", please reach a Librarian to solve the problem before returning the document");
...
public class Main {
    public static void main(String[] args) {
        ...
        // Borrowing of books by members, and see the resulting document list of the library
        System.out.println(MyLibrary.getDocumentHeldList());
        Guilhem.borrowDocument(Book1.getDocumentID(), MyLibrary); // Member borrowing a document from the library
        System.out.println(MyLibrary.getDocumentHeldList());


        // Print data from the borrow
        System.out.println(Guilhem.getCurrentBorrows().get("B0").getExpectedReturnDate()); // Part to change with ID of the document;
